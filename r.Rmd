...
## Error in setwd(dir)
Calls: local ... withCallingHandlers -> withVisible -> eval -> eval -> with_dir -> setwd
Error in Rscript_render(f, render_args, render_meta, add1, add2) : 
  Failed to compile Functions.Rmd
Calls: <Anonymous> ... render_book -> render_new_session -> Rscript_render

 I have checked information online and discussed with classmates, but there is no soluton.
